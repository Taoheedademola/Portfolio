        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24">
          ...
          >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 bg-black text-white px-6 py-3 uppercase tracking-wider text-sm font-medium w-max"
            >
          ...
          >
            <div className="overflow-hidden w-full">
              ...
              >
                FrontEnd • Smart Contract • Mobile App • UI/UX Designer • Problem Solver • Creative Thinker • Tech Enthusiast •
              </motion.div>
            </div>
          </motion.div>
        </div>
